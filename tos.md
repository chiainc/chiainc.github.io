...
## 第26条 （ユーザーの商号等の取扱い）
* チアは、チアのマーケティング、営業、広報その他これらに類する目的で、ユーザーの商号、名称、商標、ロゴマーク、サービス名その他ユーザーを識別し得る情報を利用することができるものとします。ただし、個別規約または個別契約に別段の定めがある場合を除きます。
* ユーザーが事前または事後に前項の利用停止を求めた場合、チアは、合理的な期間内に当該利用を停止するものとします。ただし、既に配布済みの印刷物、公開済みの資料、第三者媒体に掲載済みの情報その他チアの合理的な管理が及ばないものについては、この限りではありません。
* チアは、ユーザーが本サービスの利用者である旨、本サービスを用いて公開したコンテンツ、または本サービスを用いて実施した施策等について、ユーザーの秘密情報、非公開情報または個人情報を含まない一般的な表現に限り、開示または公表することができるものとします。
* 本条に基づく利用は、ユーザーの非公開情報をマーケティング目的で無断利用することを許諾するものではありません。
