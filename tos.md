...
## 第24条（免責事項）
チアは、本サービスの提供にあたり、本サービスの欠陥、本サービスの提供の停止および終了、情報の削除および変更、ならびにそれらが原因で発生したユーザーまたは第三者への損害に対し、故意がある場合を除き一切の責任を負いません。

チアは、本サービスが具備する、人工知能機能によるデータ生成について、既存人工知能機能の技術的制約に従うものであるため、入力文章構成、不適切な単語、AI性能等の影響を受け、常に正確なデータを生成できるものではなく、チアは、ユーザーに対して本機能の出力等一切の正確性を保証いたしません。

生成されたデータの著作権に関して、ユーザーは人工知能機能が基礎として採用する生成モデルまたはサービスの規約に従います。本サービスの人工知能機能が基礎として採用する生成モデルまたはサービスは次の通りです。
* Stable Diffusion: https://huggingface.co/CompVis/stable-diffusion

テキストデータから画像への変換は、チアの意思に基づき利用、加工、複製、翻案等を行うものではなく、本サービスが具備する人工知能によって専ら機械的に行われるに過ぎません。したがって、当該テキストデータまたは画像等、すべての生成データの著作権、商標権、肖像権その他の知的財産権その他の権利の保護について、チアは、いかなる関与又は保証を行うものではありません。ユーザーは、自己責任に基づき、本サービスを利用するものとし、本サービスの利用の結果、第三者の権利侵害が発生した場合においても、ユーザーの自らの責任と費用によって解決するものとし、チアは、いかなる責任も負いません。
