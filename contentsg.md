...
チアでは全ての利用者が安心してご利用いただけるようなサービス提供を心がけております。以下に関連するコンテンツに関しては違反コンテンツとして厳しく監視しています。
 ...
 - 誤解または混同を生じさせる方法で、第三者の名称、商標、個人名、評判、信用等を利用するもの（URL、ページタイトル、説明文、キーワード、メタ情報等において、当該第三者との公式な関係、提携、関与があると一般的に誤認され得る形で使用するものを含みます）
 - スパム行為、ボットその他の自動化手段によって生成・大量作成されたもの、または利用者に実質的な情報価値を提供せず、第三者サイト・サービスへの誘導やトラフィック獲得を主目的とする非倫理的または商用のもの
 - ウイルス、マルウェア、フィッシング、その他の悪意あるプログラムの配布、またはそれらのインストール、不正アクセス、情報詐取等につながるおそれのあるもの
 - 個人情報の窃取、詐取、不正収集または不正利用を目的とし、またはこれらを助長するもの
 - サイト名、URL、説明文、キーワード、メタ情報等において、他者または他団体の名称、評判、ブランドを利用し、利用者に誤認または混同を生じさせるもの
