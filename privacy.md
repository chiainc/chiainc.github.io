...
本ポリシーは、チアが運営するウェブサイト、アプリケーション、API、SaaS、その他当社が提供するサービスに適用されます。対象となる主なサービスには、https://chi.as、https://komaca.app、https://biory.app、https://biory.page、https://yay.bio、https://poge.me （以下「チアサイト」と言います。）その他当社が別途指定するサービスが含まれます。
